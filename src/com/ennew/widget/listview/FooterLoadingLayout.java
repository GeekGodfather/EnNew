package com.ennew.widget.listview;
...
//        mHintView = (TextView) findViewById(R.id.pull_to_load_footer_hint_textview);
    ...
    @Override
    protected View createLoadingView(Context context, AttributeSet attrs,int Id) {
        View container = LayoutInflater.from(context).inflate(Id, null);
        return container;
    }
