...
public class ViewHolder {
	 ...
	 * 
	 * @param convertView
	 *            This convertView is getView() method is passed
	 * @param context
	 *            The current context
	 * @param itemLayoutId
	 *            The itemLayoutId is line layout file ID
	 * @param position
	 ...
	 *            The view id
	 * @param value
	 *            The Spannable String Builder to put in the TextView
	 ...
	 *            The view id
	 * @param value
	 *            The text to put in the TextView
	 * @return The ViewHolder for chaining
	 */
	 ...
	 *            The view id
	 * @param stringResId
	 *            The text resource id to put in the TextView
	 * @return The ViewHolder for chaining
	 */
	 ...
	 *            The view id
	 * @param sb
	 *            The string builder to put in the TextView
	 * @return The ViewHolder for chaining
	 */
	 ...
	 *            The view id
	 * @param resId
	 *            A resource id to use as a background
	 * @return The ViewHolder for chaining
	 */
